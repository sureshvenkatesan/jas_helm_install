...
**Note:** See more detail steps and troubleshooting  in [distribution/test_deploy_distribution_to_jf-gcp-env.md](distribution/test_deploy_distribution_to_jf-gcp-env.md)
